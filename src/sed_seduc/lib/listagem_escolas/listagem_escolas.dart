...
class listagem_escolas extends StatelessWidget {
  const listagem_escolas({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Lista Escolas'),
        centerTitle: true,
        actions: <Widget>[
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: ListView(
              children: const [
                Titulo(name: 'Sul 1', entregue: 100, total: 200),
                EscolaCard(
                  cie: "15",
