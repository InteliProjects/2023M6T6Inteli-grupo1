...
describe('Testing Seduc Auth Rotes', () => {
    const baseUrl = '/seduc/';
    ...
    beforeAll(async () => {
        await supertest(app)
            .post('/admin/')
            .send({
                email: 'testeintegracao@gmail.com',
                password: 'teste123',
                roles: ['seduc'],
                id: 111111,
            });
        ...
        await supertest(app)
            .post('/admin/')
            .send({
                email: 'testeintegracao2@gmail.com',
                password: 'teste123',
                roles: ['school'],
                id: 222222,
            });
    ...
    describe('Testing Seduc Login', () => {
        ...
        it('Shouldnt login and should return an error (user not seduc)', async () => {
            const response = await supertest(app).post(`${baseUrl}login`).send({
                email: 'testeintegracao2@gmail.com',
                password: 'teste123',
            });
    ...
    describe('Testing Seduc Login', () => {
        ...
        beforeAll(async () => {
            ...
            tokenNotOk = (
                await supertest(app).post(`/school/login`).send({
                    email: 'testeintegracao2@gmail.com',
                    password: 'teste123',
                })
            ).body.token;
        ...
        it('Should validate and return user info', async () => {
            ...
            expect(response.body.email).toBe('testeintegracao@gmail.com');
        });
        ...
        it('Shouldnt validate (user not seduc)', async () => {
            const response = await supertest(app)
                .post(`${baseUrl}validateToken`)
